    ...
    <svg viewBox="0 0 48 48" className={className} fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="GitDarpan logo">
      <defs>
        <linearGradient id="gd" x1="6" y1="8" x2="42" y2="40" gradientUnits="userSpaceOnUse">
          <stop stopColor="#E0A83C" />
          <stop offset="1" stopColor="#9A6E22" />
        </linearGradient>
      </defs>
      <rect x="5" y="7" width="38" height="34" rx="8" fill="url(#gd)" />
      <circle cx="18" cy="17" r="3.2" fill="#0B1220" />
      <circle cx="18" cy="31" r="3.2" fill="#0B1220" />
      <circle cx="31" cy="17" r="3.2" fill="#0B1220" />
      <path d="M18 20.5v7M31 20.5c0 6-7 5-10 8" stroke="#0B1220" strokeWidth="2.6" strokeLinecap="round" />
    </svg>
  );
}
